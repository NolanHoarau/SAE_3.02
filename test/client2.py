...
class ChatClient:
    ...
    def register(self, username=None, port=None):
        ...
        try:
            ...
            error_msg = "\nX Cannot connect to master server.\n   Make sure master.py is running on port 6000"
            if not self.gui_mode:
                print(error_msg)
    ...
    def send_message(self, target_user, message, nb_layers=1):
        ...
        if not self.gui_mode:
            while True:
                try:
                    nb_layers_input = input(f"   Number of router layers (1-3 recommended): ")
                ...
                try:
                    ...
                    try:
                        ...
                        QMessageBox.warning(self, "Port occupé", 
                                          f"Le port {port} est déjà utilisé par un autre client.\n"
